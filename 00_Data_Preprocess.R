...
setwd("D:/Downloads/Dengue/Raw Data/Index")
...
str(df)
write.csv(df, "Three Districts sum of AOI AGI.csv")
...
str(df1)
write.csv(df1, "Three Districts mean ADI.csv")
...
setwd("D:/Downloads/Dengue/Raw Data/")
#happy valley
...
setwd("D:/Downloads/Dengue/Raw Data/Total Rainfall")
##Cape D'Aguilar
...
ind <- read.csv("Index/Three Districts sum of AOI AGI.csv")
adi <- read.csv("Index/Three Districts mean ADI.csv")
...
df$District <- gsub("HKK", "Hong Kong Island & Kowloon", df$District)
df$District <- gsub("NewEast", "New Territories East", df$District)
df$District <- gsub("NewWest", "New Territories West", df$District)
str(df)
write.csv(df, "Three districts all dataset-1.csv")
