...
We select several weather stations from the Hong Kong Observatory data for three districts in Hong Kong.
...
We also counted the sites that set traps in each district, and got a column entitled "Number of sites"
Then, we calculated the number of total traps, number of positive traps, and number of mosquitoes per 1000 traps based on AOI/AGI and ADI.
